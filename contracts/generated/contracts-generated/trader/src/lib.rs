...
interface Trader {
    ...
    function ensureTradePreconditions(address settlementContract, address sellToken, uint256 sellAmount, address spardose) external;
...
pub mod Trader {
    ...
    /**Function with signature `ensureTradePreconditions(address,address,uint256,address)` and selector `0x5bbe8b3f`.
    ```solidity
    function ensureTradePreconditions(address settlementContract, address sellToken, uint256 sellAmount, address spardose) external;
    ```*/
    ...
    /// [`ensureTradePreconditions(address,address,uint256,
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for ensureTradePreconditionsCall {
            ...
            const SELECTOR: [u8; 4] = [91u8, 190u8, 139u8, 63u8];
