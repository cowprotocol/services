    ...
    impl alloy_sol_types::SolInterface for SwaprRouterCalls {
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<SwaprRouterCalls>] = &[
                ...
                {
                    fn getAmountOut(data: &[u8]) -> alloy_sol_types::Result<SwaprRouterCalls> {
                ...
                {
                    fn getAmountsIn(data: &[u8]) -> alloy_sol_types::Result<SwaprRouterCalls> {
                ...
                {
                    fn getAmountIn(data: &[u8]) -> alloy_sol_types::Result<SwaprRouterCalls> {
                ...
                {
                    fn removeLiquidity(data: &[u8]) -> alloy_sol_types::Result<SwaprRouterCalls> {
                ...
                {
                    fn getAmountsOut(data: &[u8]) -> alloy_sol_types::Result<SwaprRouterCalls> {
                ...
                {
                    fn addLiquidityETH(data: &[u8]) -> alloy_sol_types::Result<SwaprRouterCalls> {
