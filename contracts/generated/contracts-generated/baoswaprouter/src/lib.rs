...
pub mod BaoswapRouter {
    ...
    impl alloy_sol_types::SolInterface for BaoswapRouterCalls {
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<BaoswapRouterCalls>] = &[
                {
                ...
                {
                    fn getAmountOut(data: &[u8]) -> alloy_sol_types::Result<BaoswapRouterCalls> {
                ...
                {
                    fn getAmountsIn(data: &[u8]) -> alloy_sol_types::Result<BaoswapRouterCalls> {
                ...
                {
                    fn getAmountIn(data: &[u8]) -> alloy_sol_types::Result<BaoswapRouterCalls> {
                ...
                {
                    fn quote(data: &[u8]) -> alloy_sol_types::Result<BaoswapRouterCalls> {
                ...
                {
                    fn removeLiquidity(data: &[u8]) -> alloy_sol_types::Result<BaoswapRouterCalls> {
                ...
                {
                    fn factory(data: &[u8]) -> alloy_sol_types::Result<BaoswapRouterCalls> {
                ...
                {
                    fn getAmountsOut(data: &[u8]) -> alloy_sol_types::Result<BaoswapRouterCalls> {
                ...
                {
                    fn addLiquidity(data: &[u8]) -> alloy_sol_types::Result<BaoswapRouterCalls> {
                ...
                {
                    fn addLiquidityETH(data: &[u8]) -> alloy_sol_types::Result<BaoswapRouterCalls> {
    ...
    impl<P, N> ::core::fmt::Debug for BaoswapRouterInstance<P, N> {
        ...
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("BaoswapRouterInstance")
                .field(&self.address)
                .finish()
        }
    }
