...
pub mod BalancerQueries {
    ...
    #[derive(Default, Debug, PartialEq, Eq, Hash)]
    ///Container type for the return parameters of the
    /// [`queryExit(bytes32,address,address,(address[],uint256[],bytes,
    /// bool))`](queryExitCall) function.
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
    ...
    #[derive(Default, Debug, PartialEq, Eq, Hash)]
    ///Container type for the return parameters of the
    /// [`queryJoin(bytes32,address,address,(address[],uint256[],bytes,
    /// bool))`](queryJoinCall) function.
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
    ...
    #[derive(Default, Debug, PartialEq, Eq, Hash)]
    ///Container type for the return parameters of the
    /// [`querySwap((bytes32,uint8,address,address,uint256,bytes),(address,bool,
    /// address,bool))`](querySwapCall) function.
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for querySwapCall {
            ...
            const SIGNATURE: &'static str = "querySwap((bytes32,uint8,address,address,uint256,\
                                             bytes),(address,bool,address,bool))";
