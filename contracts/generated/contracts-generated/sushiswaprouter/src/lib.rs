    ...
    impl alloy_sol_types::SolInterface for SushiSwapRouterCalls {
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<SushiSwapRouterCalls>] = &[
                ...
                {
                    fn getAmountOut(data: &[u8]) -> alloy_sol_types::Result<SushiSwapRouterCalls> {
                ...
                {
                    fn getAmountsIn(data: &[u8]) -> alloy_sol_types::Result<SushiSwapRouterCalls> {
                ...
                {
                    fn getAmountIn(data: &[u8]) -> alloy_sol_types::Result<SushiSwapRouterCalls> {
                ...
                {
                    fn getAmountsOut(data: &[u8]) -> alloy_sol_types::Result<SushiSwapRouterCalls> {
