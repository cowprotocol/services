...
pub mod HoneyswapRouter {
    ...
    impl alloy_sol_types::SolInterface for HoneyswapRouterCalls {
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<HoneyswapRouterCalls>] = &[
                {
                ...
                {
                    fn getAmountOut(data: &[u8]) -> alloy_sol_types::Result<HoneyswapRouterCalls> {
                ...
                {
                    fn getAmountsIn(data: &[u8]) -> alloy_sol_types::Result<HoneyswapRouterCalls> {
                ...
                {
                    fn getAmountIn(data: &[u8]) -> alloy_sol_types::Result<HoneyswapRouterCalls> {
                ...
                {
                    fn WETH(data: &[u8]) -> alloy_sol_types::Result<HoneyswapRouterCalls> {
                ...
                {
                    fn quote(data: &[u8]) -> alloy_sol_types::Result<HoneyswapRouterCalls> {
                ...
                {
                    fn factory(data: &[u8]) -> alloy_sol_types::Result<HoneyswapRouterCalls> {
                ...
                {
                    fn getAmountsOut(data: &[u8]) -> alloy_sol_types::Result<HoneyswapRouterCalls> {
                ...
                {
                    fn addLiquidity(data: &[u8]) -> alloy_sol_types::Result<HoneyswapRouterCalls> {
    ...
    impl<P, N> ::core::fmt::Debug for HoneyswapRouterInstance<P, N> {
        ...
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("HoneyswapRouterInstance")
                .field(&self.address)
                .finish()
        }
    }
...
pub type Instance = HoneyswapRouter::HoneyswapRouterInstance<::alloy_provider::DynProvider>;
use {
