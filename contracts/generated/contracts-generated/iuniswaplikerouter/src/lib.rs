...
pub mod IUniswapLikeRouter {
    ...
    impl alloy_sol_types::SolInterface for IUniswapLikeRouterCalls {
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(
                ...
                {
                    fn WETH(data: &[u8]) -> alloy_sol_types::Result<IUniswapLikeRouterCalls> {
                ...
                {
                    fn quote(data: &[u8]) -> alloy_sol_types::Result<IUniswapLikeRouterCalls> {
                ...
                {
                    fn factory(data: &[u8]) -> alloy_sol_types::Result<IUniswapLikeRouterCalls> {
    ...
    impl<P, N> ::core::fmt::Debug for IUniswapLikeRouterInstance<P, N> {
        ...
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IUniswapLikeRouterInstance")
                .field(&self.address)
                .finish()
        }
    }
...
pub type Instance = IUniswapLikeRouter::IUniswapLikeRouterInstance<::alloy_provider::DynProvider>;
