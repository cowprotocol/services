...
const SIGNATURE_HEX: &[u8] = &hex!("");
...
async fn build_replay_simulation(rpc_url: &str, full_app_data: &str) -> EthCallInputs {
    ...
    let sim_order = simulation_builder::Order::new(order_data)
        .with_signature(order_owner, Signature::Eip1271(SIGNATURE_HEX.to_vec()))
...
const NATURALLY_FAILING_SIGNATURE_HEX: &[u8] = &hex!("");
...
async fn build_naturally_failing_replay_simulation(
    ...
    let sim_order = simulation_builder::Order::new(order_data)
        .with_signature(
            order_owner,
            Signature::Eip1271(NATURALLY_FAILING_SIGNATURE_HEX.to_vec()),
        )
        .fill_at(ExecutionAmount::Full, PriceEncoding::LimitPrice);
