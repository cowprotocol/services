...
impl Enso {
    pub(crate) fn new(config: Config, chain: Chain, current_block: CurrentBlockWatcher) -> Self {
        Self {
    ...
    pub(crate) async fn simulate(&self, tx: eth::Tx) -> Result<eth::Gas, Error> {
