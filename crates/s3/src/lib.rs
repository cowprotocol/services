...
impl Uploader {
    ...
    // NOTE: PUT's the whole gzipped blob, if the gzipped JSON is larger than
    // 5MB it might be worth it to consider multipart uploads as it's the
    // minimium S3 part size
