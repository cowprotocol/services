...
impl Solver {
    ...
    pub async fn solve(
        ...
        // processing time. The EVM driver uses
        // `solving_share_of_deadline` to give the solver a configurable
        // fraction of the remaining time, leaving the rest for building
        let timeout = {
