...
mod tests {
    ...
    fn sample_auction() -> domain::Auction {
        domain::Auction {
            id: 42,
            orders: vec![domain::Order {
                uid: OrderUid([8; 32]),
                sell_mint: pubkey(1),
                buy_mint: pubkey(2),
                amount: 1_000,
    ...
    fn wire_format_is_stable() {
        let auction = Auction::new(&sample_auction(), pubkey(3));
        ...
        assert_eq!(
            ...
            json!({
                ...
                "orders": [{
                    ...
                    "buyDestination": associated_token_address(&pubkey(3), &pubkey(2))
                        .to_string(),
                    "amount": "1000",
                    "side": "sell",
                }],
