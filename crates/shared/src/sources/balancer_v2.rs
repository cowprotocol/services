...
//! `BalancerPoolRegistry` along with tools for retrieving known pools from this
//! registry on demand.
//!
...
//! retrieving requested pools from the registry and attaching the most recent
//! reserves to the result.
//!
...
//! with the     current balances of each of the pool's tokens (aka the pool's
//! "reserves").
//!
