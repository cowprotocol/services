//! Pool storage implementation which registers indexed pools.
//! 
//! This module is required because the Balancer V2 Vault does not have any view
//! methods for quering all existing pools. Instead, we must make use of events
//! that get emitted on pool creation to create a registry of known pools.
//! 
//! ---
//! 
