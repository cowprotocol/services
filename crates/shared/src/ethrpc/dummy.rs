use {
    ethcontract::{jsonrpc::Call as RpcCall, web3::RequestId},
    serde_json::Value,
    web3::{api::Web3, BatchTransport, Transport},
};

// To create an ethcontract instance we need to provide a web3 even though we
// never use it. This module provides a dummy transport and web3.
#[derive(Clone, Debug)]
