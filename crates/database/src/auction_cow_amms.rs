...
pub async fn insert(
    ...
    cow_amm_owners: &[Address],
) -> Result<(), sqlx::Error> {
    const QUERY: &str = r#"INSERT INTO auction_cow_amms (auction_id, owners) VALUES ($1, $2);"#;
    sqlx::query(QUERY)
        .bind(auction_id)
        .bind(cow_amm_owners)
        .execute(ex)
...
pub async fn fetch(
    ...
    const QUERY: &str = r#"SELECT owners FROM auction_cow_amms WHERE auction_id = $1;"#;
