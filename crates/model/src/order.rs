...
pub struct OrderMetadata {
    ...
    #[serde_as(as = "HexOrDecimalU256")]
    pub executed_total_fee: U256,
    pub executed_total_fee_token: H160,
...
mod tests {
    ...
    fn deserialization_and_back() {
        let value = json!(
        {
            ...
            "executedTotalFee": "1",
            "executedTotalFeeToken": "0x000000000000000000000000000000000000000a",
        ...
        let expected = Order {
            metadata: OrderMetadata {
                ...
                executed_total_fee: 1.into(),
                executed_total_fee_token: H160::from_low_u64_be(10),
                invalidated: true,
