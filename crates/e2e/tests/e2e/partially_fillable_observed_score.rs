...
async fn test(web3: Web3) {
    ...
    let auction_with_id = services.get_auction().await;
    let auction = auction_with_id.auction;
    ...
    tracing::info!(?latest_competition);
    assert_eq!(latest_competition, competition_1);
