...
async fn price_improvement_fee_sell_order_test(web3: Web3) {
    ...
    // (10000000000000000000 - 167058994203399) = 1190276040249790961 GNO
    //
    // final execution is 10000000000000000000 GNO for 8696424874059365746 DAI, with
    // executed_surplus_fee = 1190276040249790961 GNO
    //
    // Settlement contract balance after execution = 1190276040249790961 GNO =
    // 1190276040249790961 GNO * 8696424874059365746 / (10000000000000000000 -
    // 1190276040249790961) = 1174968274910473513 DAI
    execute_test(
        web3.clone(),
        fee_policy,
        OrderKind::Sell,
