...
impl Default for AccountGenerator {
    fn default() -> Self {
        // Start from a high number to avoid conflicts with existing accounts
        // which may have clowny delegation contracts deployed (e.g.
        // preventing to send ETH to that address)
