...
impl DecodedSettlement {
    ...
    /// orders and order owners, as the onchain settlement might include trades
    /// that are not eligible for surplus calculation(JIT orders).
    pub fn total_surplus(
        &self,
        external_prices: &ExternalPrices,
        eligible_orders: &HashSet<OrderUid>,
        eligible_owners: &HashSet<Address>,
    ) -> U256 {
        self.trades
            .iter()
            .filter(|trade| {
                eligible_orders.contains(&trade.order_uid)
                    || eligible_owners.contains(&trade.order_uid.parts().1)
            })
...
mod tests {
    ...
    #[test]
    fn total_surplus_cow_amm_order_test() {
        // transaction hash:
        // 0x9576afc86073c3aae89628072b521c37e748aa36afcf8ca1ac4e004ffea22769

        // From solver competition table:

        // surplus: 57387933137402

        let call_data = hex_literal::hex!(
            ""
        );
        let settlement = DecodedSettlement::new(&call_data, &MAINNET_DOMAIN_SEPARATOR).unwrap();
        ...
        let native_token = addr!("C02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2");
        let external_prices =
            ExternalPrices::try_from_auction_prices(native_token, BTreeMap::new()).unwrap();
        let surplus = settlement
            .total_surplus(
                &external_prices,
                &HashSet::new(),
                &settlement
                    .trades
                    .iter()
                    .map(|t| t.order_uid.parts().1)
                    .collect(),
            )
            .to_f64_lossy(); // to_f64_lossy() to mimic what happens when value is saved for solver
                             // competition
        assert_eq!(surplus, 57387933137402.);
    }
