...
impl Auction {
    ...
    pub fn is_surplus_capturing(&self, order: &domain::OrderUid, order_in_database: bool) -> bool {
        match self.classify(order, order_in_database) {
            super::solution::trade::Type::User => true,
            super::solution::trade::Type::UserOutOfAuction => false,
            super::solution::trade::Type::SurplusCapturingJit => true,
            super::solution::trade::Type::Jit => false,
        }
    }
    ...
    fn classify(
        ...
        {
            return super::solution::trade::Type::SurplusCapturingJit;
        }
        ...
        if !order_in_database {
            return super::solution::trade::Type::Jit;
        }
        // A regular user order but settled outside of the auction
        super::solution::trade::Type::UserOutOfAuction
    }
}
