...
impl From<domain::auction::order::OrderKind> for OrderKind {
    fn from(kind: domain::auction::order::OrderKind) -> Self {
        match kind {
            domain::auction::order::OrderKind::Buy => OrderKind::Buy,
            domain::auction::order::OrderKind::Sell => OrderKind::Sell,
        }
    }
}
...
impl From<domain::auction::order::Class> for Class {
    fn from(class: domain::auction::order::Class) -> Self {
        match class {
            domain::auction::order::Class::Market => Class::Market,
            domain::auction::order::Class::Limit => Class::Limit,
            domain::auction::order::Class::Liquidity => Class::Liquidity,
        }
    }
}
