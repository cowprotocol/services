...
fn convert_onchain_order_placement(
    ...
    let order = database::orders::Order {
        ...
        sell_token_balance: order_data.sell_token_balance.into(),
        buy_token_balance: order_data.buy_token_balance.into(),
...
mod test {
    ...
    fn test_convert_onchain_order_placement() {
        ...
        let expected_order = database::orders::Order {
            ...
            kind: expected_order_data.kind.into(),
            class: OrderClass::Market,
            partially_fillable: expected_order_data.partially_fillable,
            signature: order_placement.signature.1.0,
            signing_scheme: SigningScheme::Eip1271.into(),
            settlement_contract: ByteArray(settlement_contract.0),
            sell_token_balance: expected_order_data.sell_token_balance.into(),
            buy_token_balance: expected_order_data.buy_token_balance.into(),
            cancellation_timestamp: None,
        };
