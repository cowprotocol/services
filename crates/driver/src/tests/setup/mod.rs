...
pub fn ab_pool() -> Pool {
    Pool {
        token_a: "A",
        token_b: "B",
        amount_a: DEFAULT_POOL_AMOUNT_A.into_wei(),
        amount_b: DEFAULT_POOL_AMOUNT_B.into_wei(),
    }
}
...
pub fn ab_order() -> Order {
    Order {
        name: "A-B order",
        sell_amount: AB_ORDER_AMOUNT.into_wei(),
        sell_token: "A",
        buy_token: "B",
        ..Default::default()
    }
...
pub fn cd_pool() -> Pool {
    Pool {
        token_a: "C",
        token_b: "D",
        amount_a: DEFAULT_POOL_AMOUNT_C.into_wei(),
        amount_b: DEFAULT_POOL_AMOUNT_D.into_wei(),
    }
}
...
pub fn cd_order() -> Order {
    Order {
        name: "C-D order",
        sell_amount: CD_ORDER_AMOUNT.into_wei(),
        sell_token: "C",
        buy_token: "D",
        ..Default::default()
    }
...
pub fn eth_order() -> Order {
    Order {
        name: "ETH order",
        sell_amount: ETH_ORDER_AMOUNT.into_wei(),
        sell_token: "A",
        buy_token: "ETH",
        ..Default::default()
    }
...
impl<'a> SolveOk<'a> {
    ...
    pub fn default_score(self) -> Self {
        self.score_in_range(DEFAULT_SCORE_MIN.into_wei(), DEFAULT_SCORE_MAX.into_wei())
    }
...
impl<'a> SettleOk<'a> {
    ...
    pub async fn ab_order_executed(self) -> SettleOk<'a> {
        self.balance("A", Balance::SmallerBy(AB_ORDER_AMOUNT.into_wei()))
            .await
    ...
    pub async fn cd_order_executed(self) -> SettleOk<'a> {
        self.balance("C", Balance::SmallerBy(CD_ORDER_AMOUNT.into_wei()))
            .await
    ...
    pub async fn eth_order_executed(self) -> SettleOk<'a> {
        self.balance("A", Balance::SmallerBy(ETH_ORDER_AMOUNT.into_wei()))
            .await
