...
pub struct UniswapV3 {
    ...
    /// The base URL used to connect to uniswap v3 subgraph client.
...
impl BalancerV2 {
    ...
    #[allow(clippy::self_named_constructors)]
    pub fn balancer_v2(graph_api_url: &Url, network: &eth::NetworkId) -> Option<Self> {
