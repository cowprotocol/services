...
struct Config {
    ...
    disable_gas_simulation: Option<U256>,
...
/// 1000 gwei
fn default_gas_price_cap() -> U256 {
    U256::from(eth::U256::from(1000) * eth::U256::exp10(9))
}
...
/// 3 gwei
fn default_max_additional_tip() -> U256 {
    U256::from(eth::U256::from(3) * eth::U256::exp10(9))
}
