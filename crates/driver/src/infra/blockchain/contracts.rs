...
pub struct Contracts {
    ...
    balance_helper: contracts::alloy::support::Balances::Instance,
}
...
impl Contracts {
    pub(super) async fn new(
        ...
        let balance_helper = contracts::alloy::support::Balances::Instance::new(
            addresses
                .balances
    ...
    pub fn balance_helper(&self) -> &contracts::alloy::support::Balances::Instance {
        &self.balance_helper
    }
}
