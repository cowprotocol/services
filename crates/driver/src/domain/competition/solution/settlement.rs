...
impl Gas {
    ...
    pub fn new(estimate: eth::Gas, price: eth::GasPrice) -> Self {
        ...
        // Also, some solutions can have significant gas refunds that are refunded at the
        // end of execution, so we want to increase gas limit enough so those solutions
        // don't revert with out of gas error.
