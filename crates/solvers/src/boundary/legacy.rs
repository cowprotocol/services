use {
    ...
    shared::{
        http_solver::{
            gas_model::GasModel,
            model::{
                AmmModel, AmmParameters, AuctionResult, BatchAuctionModel,
                ConcentratedPoolParameters, ConstantProductPoolParameters, InternalizationStrategy,
                MetadataModel, OrderModel, Score, SettledBatchAuctionModel, SimulatedTransaction,
                SolverRejectionReason, SolverRunError, StablePoolParameters, SubmissionResult,
                TokenAmount, TokenInfoModel, TransactionWithError, WeightedPoolTokenData,
                WeightedProductPoolParameters,
            },
            DefaultHttpSolverApi, HttpSolverApi, SolverConfig,
        },
