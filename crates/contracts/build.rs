    ...
    generate_contract_with_config("Roles", |builder| {
        builder
            ...
            .add_network(
                ...
                Network {
                    address: addr("0x9646fDAD06d3e24444381f44362a3B0eB343D337"),
                    // <https://snowscan.xyz/tx/0xa54b35bf02a9f7ccff2c37453e45bcadee27d966ff1c270a35be58c288ac866f>
                    deployment_information: Some(DeploymentInformation::BlockNumber(44247166)),
                },
            )
            .add_network(
                BNB,
                Network {
                    address: addr("0x9646fDAD06d3e24444381f44362a3B0eB343D337"),
                    // <https://bscscan.com/tx/0xba39838e07c2090dc4605322df8ce266e97c5615132fa0d0d1709f0996064549>
                    deployment_information: Some(DeploymentInformation::BlockNumber(44203693)),
                },
            )
            .add_network(
                OPTIMISM,
                Network {
                    address: addr("0x9646fDAD06d3e24444381f44362a3B0eB343D337"),
                    // <https://optimistic.etherscan.io/tx/0xabeb0f75b23fce9edb95fa4eb4a7cd99d03249b34b0c21c6ec2f633e4052d3e9>
                    deployment_information: Some(DeploymentInformation::BlockNumber(121084080)),
                },
            )
            .add_network(
                POLYGON,
                Network {
                    address: addr("0x9646fDAD06d3e24444381f44362a3B0eB343D337"),
                    // <https://polygonscan.com/tx/0x11537790b0e82c6059b1addb94f4b3109e2bc7afda4aff098014d0805493c3c3>
                    deployment_information: Some(DeploymentInformation::BlockNumber(50615850)),
                },
            )
    });
