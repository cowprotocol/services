...
CREATE TABLE fee_policies (
  ...
  price_improvement_factor real CHECK (price_improvement_factor >= 0 AND price_improvement_factor <= 1),
  -- The fee should be taken as a percentage of the order volume. The value is between 0 and 1.
  volume_factor real CHECK (volume_factor >= 0 AND volume_factor <= 1),
