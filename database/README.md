...
----------------|--------------|----------|--------
 ...
 protocol\_fees | [FeeAsset][] | not null | breakdown of executed protocol fees per fee policy
...
- #### FeeAsset
Composite type representing the taken fee.

Column | Type    | Nullable | Details
-------|---------|----------|--------
amount | numeric | nullable | The fee amount taken
token  | bytea   | nullable | The token the fee amount is taken in
