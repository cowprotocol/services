...
contract GenerateConfigs is Script {
    ...
    function generateConfigFiles() internal {
        ...
        address balancesContract = vm.envAddress("BALANCES_CONTRACT_ADDRESS");
        address signaturesContract = vm.envAddress("SIGNATURES_CONTRACT_ADDRESS");
        ...
        // Generate .env.offline for docker-compose (split to avoid stack too deep)
        string memory envPart1 = string.concat(
        ...
        string memory envPart2 = string.concat(
            '\n',
        ...
        string memory envPart3 = string.concat(
            '\n',
            ...
            'BALANCES_CONTRACT_ADDRESS=', vm.toString(balancesContract), '\n',
            'SIGNATURES_CONTRACT_ADDRESS=', vm.toString(signaturesContract), '\n'
        );
        
        string memory envOffline = string.concat(envPart1, envPart2, envPart3);
